...
<body>
    <header>
        <h1 style=" background-color: #742d5c; font-family: 'Times New Roman', Times, serif;">Add Feedback</h1>
        <nav>
            <ul>
    ...
    <div class="feedback-section">
        ...
        <h2 style="background-color: #742d5c; font-family: 'Times New Roman', Times, serif;">Add Feedback</h2>
